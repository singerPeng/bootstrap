...
{{< /highlight >}}
  ...
  <div class="col-12 col-md-4 p-3 p-md-5 bg-light border border-white">
    ...
    <img class="img-fluid mt-3 mx-auto" srcset="{{ .Site.BaseUR }}/docs/{{ .Site.Params.docs_version }}/assets/img/bootstrap-themes.png,
                                                {{ .Site.BaseUR }}/docs/{{ .Site.Params.docs_version }}/assets/img/bootstrap-themes@2x.png 2x"
                                        src="{{ .Site.BaseUR }}/docs/{{ .Site.Params.docs_version }}/assets/img/bootstrap-themes.png" alt="Bootstrap Themes" width="500" height="200">
    <hr class="half-rule">
